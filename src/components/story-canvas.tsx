  ...
  function StoryCanvas({ quote, theme, platform }, ref) {
    return (
      <div className="relative">
        {/* Exportable canvas — only this div is captured via ref */}
        <div
          ref={ref}
          style={{
        ...
        {/* Preview-only badge — sits outside the ref so it is never exported */}
        <div
          className="pointer-events-none absolute top-4 right-4 z-10 flex items-center gap-1 rounded-full px-2 py-0.5"
          style={{
            backgroundColor:
              platform === "whatsapp"
